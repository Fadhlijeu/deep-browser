...
interface ElectronSessionAPI {
  create: (
    promptOrPayload: string | { prompt: string; attachments?: Array<{ name: string; mime: string; bytes: Uint8Array }>; engine?: string; browserMode?: 'MANAGED' | 'ATTACHED'; browserType?: string },
  ) => Promise<string>;
